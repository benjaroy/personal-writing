...
Always complete the full closing below, even if this skill was invoked as part of a larger conversation. After the social media comments, close by prompting the writer to decide what they want to do with the feedback. Make it clear they have three options: tell you which points to prioritize and how they want the essay revised, ask you to implement all of the feedback, or sit with it and come back later. The writer decides what gets implemented. Something in the spirit of: "If you want to revise, let me know which of these points to prioritize, or if you want me to take a run at all of them. You can also sit with this and come back when you're ready." If the most important feedback points to structural problems (the essay is trying to do too many things, the argument isn't there yet), say so and suggest going back to /sort or /sequence rather than forward to /revise. Vary this language each time.
