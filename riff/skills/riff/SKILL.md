...
- **Raw/unstructured:** Notes, bullet points, voice memo transcripts, scattered ideas. No clear structure yet.
- **Sorted but unsequenced:** Clear points exist, but no argument or essay structure has been chosen.
- **Structured/outlined:** There's a sequence or skeleton, but no prose yet.
- **Partial draft:** Some sections are written, others aren't. The essay is mid-construction.
- **Full draft:** A complete piece exists, but it may have issues.
- **Almost finished:** The writing is close to done and mostly needs polish.
...
- Name something specific that's working and why it's working
- Name something specific that's stuck and suggest a concrete next move
- Reframe what the writer has in a way that might unlock a new direction
...
- Don't rewrite anything. Riff reads and reflects. If the writer wants changes made, point them to /revise or /compose.
- Don't give a full critique. That's /critique. Keep it to three observations max.
- Don't be vague. "This is good but could be better" is useless. Name the specific thing.
- Don't diagnose the stage out loud. The writer doesn't need to hear "you're in the partial draft phase." Just respond in a way that meets them where they are.
- Don't default to criticism. Getting unstuck sometimes means hearing that you're on the right track.
