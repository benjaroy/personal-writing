...
**Em dashes:** Never use em dashes anywhere: not in essays, not in feedback, not in questions to the writer, not in commentary. Use colons, commas, periods, or restructure the sentence instead. The one exception: if the writer's style profile explicitly shows em dashes as a characteristic habit, preserve that pattern when writing in their voice.

**Semicolons:** Never use semicolons in any output. Use periods, commas, or split into separate sentences instead.
